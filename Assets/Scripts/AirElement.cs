...
public class AirElement : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == combiningElement1Tag || other.tag == combiningArea1Tag)
        {
            ...
            Instantiate(combinedElement1, DetectGroundHeight(other.transform.position.x, other.transform.position.z) - new Vector3(0, 1.31f, 0), combinedElement1.transform.rotation);
        }
        ...
        else if (other.tag == "Enemy") // Checks if the element collides with an enemy or the ground
        {
            ...
            Instantiate(elementArea, DetectGroundHeight(other.transform.position.x, other.transform.position.z) - new Vector3(0, 1.3f, 0), elementArea.transform.rotation);
        }
